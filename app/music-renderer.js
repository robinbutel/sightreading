...
function draw_initial_measures(treble_notes, bass_notes) {
  var stave_treble = new VF.Stave(50, current_line * 250 + 10, measure_width);
  var stave_bass = new VF.Stave(50, current_line * 250 + 110, measure_width);

  stave_treble.addClef("treble").addKeySignature("G").setContext(context);
  stave_bass.addClef("bass").setContext(context);

  if(current_line == 0) {
    stave_treble.addTimeSignature("4/4");
    stave_bass.addTimeSignature("4/4");
  }
...
function draw_measure(treble_notes, bass_notes) {
  ...
  var tstave = new VF.Stave(treble_current_x, treble_current_y, measure_width);
  var bstave = new VF.Stave(bass_current_x, bass_current_y, measure_width);
